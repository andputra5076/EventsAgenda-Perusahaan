			...
			<tr>
				...
				<td>
					<?php if ($berita['jenis_berita'] == 'Profil') : ?>
						<a href="<?php echo base_url('berita/profil/' . $berita['slug_berita']) ?>" class="btn btn-info btn-sm" target="_blank">
							<i class="fa fa-eye"></i> Baca
						</a>
					<?php elseif ($berita['jenis_berita'] == 'Berita') : ?>
						<a href="<?php echo base_url('berita/read/' . $berita['slug_berita']) ?>" class="btn btn-info btn-sm" target="_blank">
							<i class="fa fa-eye"></i> Baca
						</a>
					<?php endif; ?>
